...
async function getPoolGenesisTxnPath(poolName, ipaddr = '3.36.116.41', force) {
  // let path = `${os.tmpdir()}/indy/${poolName}.txn`
  let path = __dirname + `/indy_genesis_${poolName}.txt`
  // if (!fs.existsSync(path)) {
  await savePoolGenesisTxnFile(path, ipaddr, force)
  // }
  return path
}

async function savePoolGenesisTxnFile(filePath, ipaddr, force = false) {
  let data = poolGenesisTxnData(ipaddr)
...
function pathToIndyClientHome() {
  // let path = `${os.tmpdir()}/indy/${poolName}.txn`
  let path = __dirname + `/indy_client_${poolName}`
  return path
...
function poolGenesisTxnData(poolIp) {
  // let poolIp = process.env.TEST_POOL_IP || '3.36.116.41' // '192.168.0.10' //'192.168.1.5'
  ...
  // return `{
  //   "auditPath": [
  //     "HdwPkqpBkow7kULfaHeCaPunHCeyL3SD5WBt7wbfJV9v",
  //     "HCuiAXaP6kz4CpXTe1rqiznsHxn9fQLMvCaFtmxK5Yz2"
  //   ],
  //   "ledgerSize": 4,
  //   "reqSignature": {},
  //   "rootHash": "Cb3eKYmpFB99zyviJCwBco7RGRkE3aFaY6uJcPVosE2K",
  //   "txn": {
  //     "data": {
  //       "data": {
  //         "alias": "Node1",
  ...
  // {
  //   "auditPath": [
  //     "3yJgw8x8BzFMFqP2b63fJMM12iE1iqKtojyvYqfoyX9u",
  //     "HCuiAXaP6kz4CpXTe1rqiznsHxn9fQLMvCaFtmxK5Yz2"
  //   ],
  //   "ledgerSize": 4,
  //   "reqSignature": {},
  ...
  // {
  //   "auditPath": [
  //     "5iguAfiK4bZXktHvjWwGS1Gb84EeTrPo1rdkyp2WApDq",
  //     "6yqBzZxyVUvD6vmBZdYKHWtibeRYywZ55CVAsYjTfvx5"
  //   ],
  //   "ledgerSize": 4,
  //   "reqSignature": {},
  //   "rootHash": "Cb3eKYmpFB99zyviJCwBco7RGRkE3aFaY6uJcPVosE2K",
  ...
  // {
  //   "auditPath": [
  //     "rettJ8eK6d2jDo8GpE3nU9wvHhFZcB2WaXha6kjFdLm",
  //     "6yqBzZxyVUvD6vmBZdYKHWtibeRYywZ55CVAsYjTfvx5"
  //   ],
  //   "ledgerSize": 4,
  //   "reqSignature": {},
