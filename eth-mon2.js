...
console.log('Listen')
const contract_addr = '0xd1c3AE3aed7786394bdB5A42a81F0b0Fb28F7983'
const sender_skey =
...
const contract = new ethers.Contract(contract_addr, abi, sender_wallet)

// contract.transfer(receiver_addr, 10)
contract.transferFrom(sender_addr, receiver_addr, '809299387811318528485')
