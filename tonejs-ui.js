!(function (t) {
  ...
  function (t, e, n) {
          ...
          r = (e) => {
            ...
            for (; a.nextNode(); ) {
              ...
              if (1 === e.nodeType) {
                ...
                for (let t = 0; t < a; t++)
                  r.insertBefore(
                    '' === s[t] ? f() : document.createTextNode(s[t]),
                    e
                  ),
                    this.parts.push({
                      type: 'node',
                ...
                r.insertBefore(
                  '' === s[a] ? f() : document.createTextNode(s[a]),
                  e
                ),
                  o.push(e)
                ...
                if (e.nodeValue === l) {
                  const t = e.parentNode,
                    r = e.previousSibling
                  null === r || r !== c || r.nodeType !== Node.TEXT_NODE
                    ? t.insertBefore(f(), e)
                    : n--,
                    this.parts.push({
                      type: 'node',
                    ...
                    o.push(e),
                    null === e.nextSibling ? t.insertBefore(f(), e) : n--,
                    (d = c),
                    i++
                } else {
                  let t = -1
                  for (; -1 !== (t = e.nodeValue.indexOf(l, t + 1)); )
                    this.parts.push({
                      type: 'node',
                      index: -1,
                    })
    ...
    class b {
      ...
      update(t) {
        let e = 0
        for (const n of this._parts) void 0 !== n && n.setValue(t[e]), e++
          ...
          for (; n < e.length && null !== s; ) {
            ...
            if (p(t))
              if (i === t.index) {
                ...
                i++,
                  'TEMPLATE' === s.nodeName && o(s.content),
                  (s = r.nextNode())
    ...
    class m {
      ...
      getHTML() {
        ...
        for (let n = 0; n < t; n++) {
          ...
          let i = !1
          ;(e += t.replace(v, (t, e, n, o) => ((i = !0), e + n + h + o + l))),
            i || (e += c)
        }
    ...
    class x {
      ...
      setValue(t) {
        t === a ||
          (g(t) && t === this.value) ||
          ((this.value = t), o(t) || (this.committer.dirty = !0))
      }
      commit() {
        for (; o(this.value); ) {
          const t = this.value
    ...
    const I = new (class {
      handleAttributeExpressions(t, e, n, i) {
        const o = e[0]
        return '.' === o
          ? new S(t, e.slice(1), n).parts
          : '@' === o
          ? [new M(t, e.slice(1), i.eventContext)]
          : '?' === o
          ? [new w(t, e.slice(1), n)]
          : new y(t, e, n).parts
      }
    ...
    function T(t) {
      ...
      return (
        void 0 === (n = e.keyString.get(i)) &&
          ((n = new d(t, t.getTemplateElement())), e.keyString.set(i, n)),
    ...
    function R(t, e) {
      const {
        ...
        o = document.createTreeWalker(n, O, null, !1)
      let r = F(i),
        s = i[r],
        a = -1,
        l = 0
      ...
      for (; o.nextNode(); ) {
        ...
        for (
          t.previousSibling === u && (u = null),
            e.has(t) && (c.push(t), null === u && (u = t)),
            null !== u && l++;
          void 0 !== s && s.index === a;

        )
          (s.index = null !== u ? -1 : s.index - l), (s = i[(r = F(i, r))])
      }
      c.forEach((t) => t.parentNode.removeChild(t))
    }
    const $ = (t) => {
        let e = t.nodeType === Node.DOCUMENT_FRAGMENT_NODE ? 0 : 1
        const n = document.createTreeWalker(t, O, null, !1)
        for (; n.nextNode(); ) e++
        return e
      },
      F = (t, e = -1) => {
          ...
          (function (t, e, n = null) {
            ...
            for (; r.nextNode(); )
              for (
                l++,
                  r.currentNode === n &&
                    ((a = $(e)), n.parentNode.insertBefore(e, n));
                -1 !== s && o[s].index === l;

              ) {
                if (a > 0) {
                  for (; -1 !== s; ) (o[s].index += a), (s = F(o, s))
                  return
                }
                s = F(o, s)
              }
    ...
    class X extends HTMLElement {
      ...
      static createProperty(t, e = U) {
        ...
        if ((this._classProperties.set(t, e), this.prototype.hasOwnProperty(t)))
          return
      ...
      static _valueHasChanged(t, e, n = G) {
        return n(t, e)
      }
      static _propertyValueFromAttribute(t, e) {
        ...
        const i =
          n === Boolean ? V : 'function' == typeof n ? n : n.fromAttribute
        return i ? i(t) : t
      }
      static _propertyValueToAttribute(t, e) {
        if (void 0 === e || void 0 === e.reflect) return
        return (
          e.type === Boolean ? B : (e.type && e.type.toAttribute) || String
        )(t)
      }
      initialize() {
      ...
      requestUpdate(t, e) {
        if (void 0 !== t) {
          const n = this.constructor._classProperties.get(t) || U
      ...
      update(t) {
        if (
          ...
          for (const [t, e] of this._reflectingProperties)
    ...
    ;(X._attributeToPropertyMap = new Map()),
      (X._finalized = !0),
      (X._classProperties = new Map()),
      (X.properties = {})
    /**
     * @license
     * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
    ...
    Z.render = (t, e, n) => {
      ...
      if (
        ...
        const t = N.get(l)
        N.delete(l),
          t.value instanceof b && H(l, t.value.template, i),
          s(e, e.firstChild),
          e.appendChild(l),
          N.set(e, t)
      }
  ...
  function (t, e, n) {
    ...
    ;(function (t) {
      ...
      class o extends i.a {
        ...
        constructor() {
          super(), (this.collapsed = !1), (this._syncTimeout = -1)
        }
        setAttribute(t, e, n) {
          e.set(n)
        }
        bind(e) {
          Array.from(this.shadowRoot.querySelectorAll('[attribute]')).forEach(
            (n) => {
              const i = n.getAttribute('attribute')
              this.addEventListener(i, (n) => {
                t.Tone.isDefined(e[i]) &&
                  (t.Tone.isDefined(e[i].value)
                    ? (e[i].value = n.detail)
                    : (e[i] = n.detail)),
                  this.sync(e)
              })
            ...
            Array.from(this.shadowRoot.querySelectorAll('[component]')).forEach(
              (t) => {
            ...
            this.sync(e),
            this.addEventListener('collapse', () => this.sync(e)),
            this.addEventListener('sync', () => this.sync(e))
        }
        sync(t) {
          Array.from(this.shadowRoot.querySelectorAll('[attribute]')).forEach(
            (e) => {
    ...
    ;(n(13).inspectSource = function (t) {
      ...
      (t.exports = function (t, e, n, a) {
        ...
        c && (r(n, 'name') || o(n, 'name', e)),
          t[e] !== n &&
            (c && (r(n, s) || o(n, s, t[e] ? '' + t[e] : l.join(String(e)))),
            t === i
              ? (t[e] = n)
              : a
              ? t[e]
  ...
  function (t, e, n) {
    ...
    if (n(9)) {
      var i = n(35),
        ...
        At = function (t, e) {
          return It(P(t, t[mt]), e)
        },
        It = function (t, e) {
          for (var n = 0, i = e.length, o = Mt(t, i); i > n; ) o[n] = e[n++]
          return o
        },
        Tt = function (t, e, n) {
          j(t, e, {
        ...
        Ct = function (t) {
          var e,
            ...
            d = A(a)
          if (null != d && !S(d)) {
            for (s = d.call(a), i = [], e = 0; !(r = s.next()).done; e++)
              i.push(r.value)
            a = i
          }
          for (
        ...
        Ot = function () {
          return pt.apply(Pt ? ht.call(kt(this)) : kt(this), arguments)
        },
        Rt = {
        ...
        Lt = function (t, e) {
          return Dt(t, (e = g(e, !0))) ? h(2, t[e]) : H(t, e)
        },
        qt = function (t, e, n) {
          return !(Dt(t, (e = g(e, !0))) && _(n) && y(n, 'value')) ||
            y(n, 'get') ||
            y(n, 'set') ||
            n.configurable ||
        ...
        (t.exports = function (t, e, n, l) {
          ...
          y
            ? ((f = n(function (t, n, i, o) {
                ...
                if (_(n)) {
                  if (
                    ...
                    return yt in n ? It(f, n) : Ct.call(f, n)
                  ;(r = n), (p = Et(i, e))
                  var m = n.byteLength
                  if (void 0 === o) {
                    if (m % e) throw V('Wrong length!')
                    if ((s = m - p) < 0) throw V('Wrong length!')
                  } else if ((s = v(o) * e) + p > m) throw V('Wrong length!')
                  a = s / e
            ...
            : (r(function () {
              ...
              K(
                g !== Function.prototype ? M(m).concat(M(g)) : M(m),
                function (t) {
                  t in f || d(f, t, m[t])
                }
              ),
            ...
            s(
              s.P +
                s.F *
                  (r(function () {
                    return (
                      [1, 2].toLocaleString() != new f([1, 2]).toLocaleString()
                    )
                  }) ||
                    !r(function () {
      ...
      function (t, e, n, h, d) {
        ...
        if (r(m)) {
          for (p = a(t.length); p > y; y++)
            if ((b = e ? g(s((f = t[y]))[0], f[1]) : g(t[y])) === c || b === u)
              return b
        } else
  ...
  function (t, e, n) {
    ...
    !(function (n) {
      'use strict'
      function o() {
        if (o.prototype._singleton)
          throw new Error(
            'WebMidi is a singleton, it cannot be instantiated directly.'
          )
        ;(o.prototype._singleton = this),
          (this._inputs = []),
          (this._outputs = []),
          (this._userHandlers = {}),
      ...
      ;(o.prototype.enable = function (t, e) {
        return this.enabled
                ...
                function (e) {
                  function n() {
                    clearTimeout(i),
                      ...
                      (this.interface.onstatechange =
                        this._onInterfaceStateChange.bind(this)),
                  ...
                  for (
                    var s = e.inputs.values(), a = s.next();
                    a && !a.done;
                    a = s.next()
                  )
                    r.push(a.value.open())
                  for (
                    var l = e.outputs.values(), c = l.next();
                    c && !c.done;
                    c = l.next()
                  )
                    r.push(c.value.open())
                  ;(i = setTimeout(n.bind(this), 200)),
                    Promise &&
                      Promise.all(r)
                        .catch(function (t) {})
                        .then(n.bind(this))
          ...
          : void (
              'function' == typeof t &&
              t(new Error('The Web MIDI API is not supported by your browser.'))
            )
      }),
        ...
        (o.prototype.hasListener = function (t, e) {
          if (!this.enabled)
            throw new Error(
        ...
        (o.prototype.removeListener = function (t, e) {
          ...
          if (this._midiInterfaceEvents.indexOf(t) >= 0)
            if (e)
              for (var n = 0; n < this._userHandlers[t].length; n++)
                this._userHandlers[t][n] === e &&
                  this._userHandlers[t].splice(n, 1)
        ...
        (o.prototype.toMIDIChannels = function (t) {
          var e
          return (
            (e =
              'all' === t || void 0 === t
        ...
        (o.prototype.getInputById = function (t) {
        ...
        (o.prototype.getOctave = function (t) {
          return null != t && t >= 0 && 127 >= t
            ? Math.floor(Math.floor(t) / 12 - 1) + Math.floor(a.octaveOffset)
            : void 0
        }),
        (o.prototype.getOutputByName = function (t) {
          if (!this.enabled) throw new Error('WebMidi is not enabled.')
          for (var e = 0; e < this.outputs.length; e++)
            if (~this.outputs[e].name.indexOf(t)) return this.outputs[e]
          return !1
        }),
        (o.prototype.guessNoteNumber = function (t) {
          var e = !1
          if (
            (t && t.toFixed && t >= 0 && 127 >= t
              ? (e = Math.round(t))
              : parseInt(t) >= 0 && parseInt(t) <= 127
              ? (e = parseInt(t))
              : ('string' == typeof t || t instanceof String) &&
                (e = this.noteNameToNumber(t)),
            !1 === e)
          )
            throw new Error('Invalid input value (' + t + ').')
          return e
        }),
        (o.prototype.noteNameToNumber = function (t) {
          'string' != typeof t && (t = '')
          ...
          if (
            (e[2].toLowerCase().indexOf('b') > -1
              ? (i -= e[2].length)
              : e[2].toLowerCase().indexOf('#') > -1 && (i += e[2].length),
            0 > i || i > 127)
          )
        ...
        (o.prototype._updateInputs = function () {
          for (var t = 0; t < this._inputs.length; t++) {
            for (
              var e = !0, n = this.interface.inputs.values(), i = n.next();
              i && !i.done;
              i = n.next()
            )
        ...
        (o.prototype._updateOutputs = function () {
          for (var t = 0; t < this._outputs.length; t++) {
            for (
              var e = !0, n = this.interface.outputs.values(), i = n.next();
              i && !i.done;
              i = n.next()
            )
          ...
          this.interface &&
            this.interface.outputs.forEach(
              function (t) {
        ...
        (o.prototype._onInterfaceStateChange = function (t) {
          ...
          this.interface && 'connected' === t.port.state
            ? 'output' === t.port.type
              ? (e.port = this.getOutputById(t.port.id))
              : 'input' === t.port.type &&
                (e.port = this.getInputById(t.port.id))
            : (e.port = {
                connection: 'closed',
                id: t.port.id,
        ...
        (r.prototype.addListener = function (t, e, n) {
          var i = this
          if (
            (void 0 === e && (e = 'all'),
            Array.isArray(e) || (e = [e]),
        ...
        (r.prototype.hasListener = function (t, e, n) {
          var i = this
          ...
          if (
            ...
            void 0 !== a.MIDI_SYSTEM_MESSAGES[t])
          ) {
        ...
        (r.prototype.removeListener = function (t, e, n) {
          ...
          if (
            ...
            if (void 0 === n) this._userHandlers.system[t] = []
              ...
              for (var o = 0; o < this._userHandlers.system[t].length; o++)
                this._userHandlers.system[t][o] === n &&
                  this._userHandlers.system[t].splice(o, 1)
          else if (void 0 !== a.MIDI_CHANNEL_MESSAGES[t]) {
            if (e.indexOf('all') > -1) {
              e = []
              for (var r = 1; 16 >= r; r++) e.push(r)
        ...
        (r.prototype._initializeUserHandlers = function () {
          for (var t in a.MIDI_CHANNEL_MESSAGES)
            a.MIDI_CHANNEL_MESSAGES.hasOwnProperty(t) &&
              (this._userHandlers.channel[t] = {})
          for (var e in a.MIDI_SYSTEM_MESSAGES)
            a.MIDI_SYSTEM_MESSAGES.hasOwnProperty(e) &&
              (this._userHandlers.system[e] = [])
        }),
        (r.prototype._onMidiMessage = function (t) {
          ...
          t.data[0] < 240
            ? this._parseChannelEvent(t)
            : t.data[0] <= 255 && this._parseSystemEvent(t)
        }),
        (r.prototype._parseChannelEvent = function (t) {
          var e,
            ...
            o = 1 + (15 & t.data[0])
          t.data.length > 1 &&
            ((e = t.data[1]), (n = t.data.length > 2 ? t.data[2] : void 0))
          var r = {
            target: this,
            data: t.data,
            timestamp: t.timeStamp,
          ...
          i === a.MIDI_CHANNEL_MESSAGES.noteoff ||
          (i === a.MIDI_CHANNEL_MESSAGES.noteon && 0 === n)
            ? ((r.type = 'noteoff'),
              (r.note = {
                number: e,
                name: a._notes[e % 12],
              ...
              (r.velocity = n / 127),
              (r.rawVelocity = n))
            : i === a.MIDI_CHANNEL_MESSAGES.noteon
            ? ((r.type = 'noteon'),
              (r.note = {
                number: e,
                name: a._notes[e % 12],
              ...
              (r.velocity = n / 127),
              (r.rawVelocity = n))
            : i === a.MIDI_CHANNEL_MESSAGES.keyaftertouch
            ? ((r.type = 'keyaftertouch'),
              (r.note = {
                number: e,
                name: a._notes[e % 12],
                octave: a.getOctave(e),
              ...
              (r.value = n / 127))
            : i === a.MIDI_CHANNEL_MESSAGES.controlchange && e >= 0 && 119 >= e
            ? ((r.type = 'controlchange'),
              (r.controller = {
                number: e,
                name: this.getCcNameByNumber(e),
              }),
              (r.value = n))
            : i === a.MIDI_CHANNEL_MESSAGES.channelmode && e >= 120 && 127 >= e
            ? ((r.type = 'channelmode'),
              (r.controller = {
                number: e,
              ...
              (r.value = n))
            : i === a.MIDI_CHANNEL_MESSAGES.programchange
            ? ((r.type = 'programchange'), (r.value = e))
            : i === a.MIDI_CHANNEL_MESSAGES.channelaftertouch
            ? ((r.type = 'channelaftertouch'), (r.value = e / 127))
            : i === a.MIDI_CHANNEL_MESSAGES.pitchbend
            ? ((r.type = 'pitchbend'), (r.value = ((n << 7) + e - 8192) / 8192))
            : (r.type = 'unknownchannelmessage'),
            this._userHandlers.channel[r.type] &&
              this._userHandlers.channel[r.type][o] &&
              this._userHandlers.channel[r.type][o].forEach(function (t) {
                t(r)
              })
        }),
        (r.prototype.getCcNameByNumber = function (t) {
          if (!((t = Math.floor(t)) >= 0 && 119 >= t))
            throw new RangeError(
              'The control change number must be between 0 and 119.'
            )
          for (var e in a.MIDI_CONTROL_CHANGE_MESSAGES)
            if (
              a.MIDI_CONTROL_CHANGE_MESSAGES.hasOwnProperty(e) &&
              t === a.MIDI_CONTROL_CHANGE_MESSAGES[e]
            )
              return e
        }),
        (r.prototype.getChannelModeByNumber = function (t) {
          if (!((t = Math.floor(t)) >= 120 && status <= 127))
            throw new RangeError(
              'The control change number must be between 120 and 127.'
            )
          for (var e in a.MIDI_CHANNEL_MODE_MESSAGES)
            if (
              a.MIDI_CHANNEL_MODE_MESSAGES.hasOwnProperty(e) &&
              t === a.MIDI_CHANNEL_MODE_MESSAGES[e]
            )
              return e
        }),
        (r.prototype._parseSystemEvent = function (t) {
          ...
          e === a.MIDI_SYSTEM_MESSAGES.sysex
            ? (n.type = 'sysex')
            : e === a.MIDI_SYSTEM_MESSAGES.timecode
            ? (n.type = 'timecode')
            : e === a.MIDI_SYSTEM_MESSAGES.songposition
            ? (n.type = 'songposition')
            : e === a.MIDI_SYSTEM_MESSAGES.songselect
            ? ((n.type = 'songselect'), (n.song = t.data[1]))
            : e === a.MIDI_SYSTEM_MESSAGES.tuningrequest
            ? (n.type = 'tuningrequest')
            : e === a.MIDI_SYSTEM_MESSAGES.clock
            ? (n.type = 'clock')
            : e === a.MIDI_SYSTEM_MESSAGES.start
            ? (n.type = 'start')
            : e === a.MIDI_SYSTEM_MESSAGES.continue
            ? (n.type = 'continue')
            : e === a.MIDI_SYSTEM_MESSAGES.stop
            ? (n.type = 'stop')
            : e === a.MIDI_SYSTEM_MESSAGES.activesensing
            ? (n.type = 'activesensing')
            : e === a.MIDI_SYSTEM_MESSAGES.reset
            ? (n.type = 'reset')
            : (n.type = 'unknownsystemmessage'),
            this._userHandlers.system[n.type] &&
              this._userHandlers.system[n.type].forEach(function (t) {
                t(n)
              })
        }),
        (s.prototype.send = function (t, e, n) {
          ...
          return (
            e.forEach(function (t, e) {
              ...
              if (!(n >= 0 && 255 >= n))
                throw new RangeError(
                  'Data bytes must be integers between 0 (0x00) and 255 (0xFF).'
                )
              i.push(n)
            }),
            this._midiOutput.send([t].concat(i), parseFloat(n) || 0),
            this
          )
        }),
        (s.prototype.sendSysex = function (t, e, n) {
          ...
          return (
            ...
            this.send(
              a.MIDI_SYSTEM_MESSAGES.sysex,
              e,
              this._parseTimeParameter(n.time)
            ),
            this
          )
        }),
        (s.prototype.sendTimecodeQuarterFrame = function (t, e) {
          return (
            (e = e || {}),
            this.send(
              a.MIDI_SYSTEM_MESSAGES.timecode,
              t,
              this._parseTimeParameter(e.time)
            ),
            this
          )
        }),
        (s.prototype.sendSongPosition = function (t, e) {
          ...
          return (
            this.send(
              a.MIDI_SYSTEM_MESSAGES.songposition,
              [n, i],
              this._parseTimeParameter(e.time)
            ),
            this
        ...
        (s.prototype.sendSongSelect = function (t, e) {
          if (((e = e || {}), !((t = Math.floor(t)) >= 0 && 127 >= t)))
            throw new RangeError('The song number must be between 0 and 127.')
          return (
            this.send(
              a.MIDI_SYSTEM_MESSAGES.songselect,
              [t],
              this._parseTimeParameter(e.time)
            ),
            this
        ...
        (s.prototype.sendTuningRequest = function (t) {
          return (
            (t = t || {}),
            this.send(
              a.MIDI_SYSTEM_MESSAGES.tuningrequest,
              void 0,
              this._parseTimeParameter(t.time)
            ),
            this
          )
        }),
        ...
        (s.prototype.sendContinue = function (t) {
          return (
            (t = t || {}),
            this.send(
              a.MIDI_SYSTEM_MESSAGES.continue,
              void 0,
              this._parseTimeParameter(t.time)
            ),
            this
        ...
        (s.prototype.sendActiveSensing = function (t) {
          return (
            (t = t || {}),
            this.send(
              a.MIDI_SYSTEM_MESSAGES.activesensing,
              [],
              this._parseTimeParameter(t.time)
            ),
            this
          ...
          return (
            (n = n || {}).rawVelocity
              ...
              : !isNaN(n.velocity) &&
                ...
                n.velocity <= 1 &&
                (i = 127 * n.velocity),
            this._convertNoteToArray(t).forEach(
              function (t) {
                a.toMIDIChannels(e).forEach(
                  function (e) {
                    this.send(
                      (a.MIDI_CHANNEL_MESSAGES.noteoff << 4) + (e - 1),
                      [t, Math.round(i)],
                      this._parseTimeParameter(n.time)
                    )
                  }.bind(this)
            ...
            this._convertNoteToArray(t).forEach(
              function (t) {
                a.toMIDIChannels(e).forEach(
                  function (e) {
                    this.send(
                      (a.MIDI_CHANNEL_MESSAGES.noteon << 4) + (e - 1),
                      [t, Math.round(i)],
                      n.time
                    )
                  }.bind(this)
        ...
        (s.prototype.sendControlChange = function (t, e, n, i) {
          ...
          } else if (!((t = Math.floor(t)) >= 0 && 119 >= t))
            throw new RangeError(
              'Controller numbers must be between 0 and 119.'
            )
          if (!((e = Math.floor(e) || 0) >= 0 && 127 >= e))
            throw new RangeError('Controller value must be between 0 and 127.')
          return (
            a.toMIDIChannels(n).forEach(
              function (n) {
                this.send(
                  (a.MIDI_CHANNEL_MESSAGES.controlchange << 4) + (n - 1),
                  [t, e],
                  this._parseTimeParameter(i.time)
                )
              }.bind(this)
            ),
            this
        ...
        (s.prototype._selectRegisteredParameter = function (t, e, n) {
          var i = this
          if (((t[0] = Math.floor(t[0])), !(t[0] >= 0 && t[0] <= 127)))
            throw new RangeError(
              'The control65 value must be between 0 and 127'
            )
          if (((t[1] = Math.floor(t[1])), !(t[1] >= 0 && t[1] <= 127)))
            throw new RangeError(
              'The control64 value must be between 0 and 127'
            )
          return (
            a.toMIDIChannels(e).forEach(function (o) {
        ...
        (s.prototype._selectNonRegisteredParameter = function (t, e, n) {
          ...
          if (((t[0] = Math.floor(t[0])), !(t[0] >= 0 && t[0] <= 127)))
            throw new RangeError(
              'The control63 value must be between 0 and 127'
            )
          if (((t[1] = Math.floor(t[1])), !(t[1] >= 0 && t[1] <= 127)))
            throw new RangeError(
              'The control62 value must be between 0 and 127'
            )
          return (
            a.toMIDIChannels(e).forEach(function (o) {
        ...
        (s.prototype._deselectRegisteredParameter = function (t, e) {
          var n = this
          return (
            a.toMIDIChannels(t).forEach(function (i) {
        ...
        (s.prototype.setRegisteredParameter = function (t, e, n, i) {
          ...
          return (
            a.toMIDIChannels(n).forEach(function (r) {
              o._selectRegisteredParameter(t, n, i.time),
                o._setCurrentRegisteredParameter(e, n, i.time),
                o._deselectRegisteredParameter(n, i.time)
            }),
            this
          )
        }),
        (s.prototype.setNonRegisteredParameter = function (t, e, n, i) {
          ...
          return (
            (e = [].concat(e)),
            a.toMIDIChannels(n).forEach(function (r) {
              o._selectNonRegisteredParameter(t, n, i.time),
                o._setCurrentRegisteredParameter(e, n, i.time),
                o._deselectRegisteredParameter(n, i.time)
            }),
            this
        ...
        (s.prototype.setPitchBendRange = function (t, e, n, i) {
          var o = this
          if (((i = i || {}), !((t = Math.floor(t) || 0) >= 0 && 127 >= t)))
            throw new RangeError(
              'The semitones value must be between 0 and 127'
            )
          if (!((e = Math.floor(e) || 0) >= 0 && 127 >= e))
            throw new RangeError('The cents value must be between 0 and 127')
          return (
            a.toMIDIChannels(n).forEach(function (r) {
              o.setRegisteredParameter('pitchbendrange', [t, e], n, {
                time: i.time,
              })
            }),
            this
        ...
        (s.prototype.setModulationRange = function (t, e, n, i) {
          ...
          return (
            a.toMIDIChannels(n).forEach(function (r) {
              o.setRegisteredParameter('modulationrange', [t, e], n, {
                time: i.time,
              })
            }),
            this
        ...
        (s.prototype.setMasterTuning = function (t, e, n) {
          var i = this
          if (((n = n || {}), -65 >= (t = parseFloat(t) || 0) || t >= 64))
            throw new RangeError(
          ...
          var o = Math.floor(t) + 64,
            ...
            l = 127 & r
          return (
            a.toMIDIChannels(e).forEach(function (t) {
              i.setRegisteredParameter('channelcoarsetuning', o, e, {
                time: n.time,
              }),
                i.setRegisteredParameter('channelfinetuning', [s, l], e, {
                  time: n.time,
                })
            }),
            this
        ...
        (s.prototype.setTuningBank = function (t, e, n) {
          var i = this
          if (((n = n || {}), !((t = Math.floor(t) || 0) >= 0 && 127 >= t)))
        ...
        (s.prototype.sendChannelMode = function (t, e, n, i) {
          ...
          } else if (!((t = Math.floor(t)) >= 120 && 127 >= t))
            throw new RangeError(
              'Channel mode numerical identifiers must be between 120 and 127.'
            )
          if (0 > (e = Math.floor(e) || 0) || e > 127)
            throw new RangeError('Value must be an integer between 0 and 127.')
          return (
            a.toMIDIChannels(n).forEach(
              function (n) {
                this.send(
                  (a.MIDI_CHANNEL_MESSAGES.channelmode << 4) + (n - 1),
                  [t, e],
                  this._parseTimeParameter(i.time)
                )
              }.bind(this)
        ...
        (s.prototype.sendProgramChange = function (t, e, n) {
          var i = this
          if (
            ((n = n || {}), (t = Math.floor(t)), isNaN(t) || 0 > t || t > 127)
          )
            throw new RangeError('Program numbers must be between 0 and 127.')
          return (
            a.toMIDIChannels(e).forEach(function (e) {
              i.send(
                (a.MIDI_CHANNEL_MESSAGES.programchange << 4) + (e - 1),
                [t],
                i._parseTimeParameter(n.time)
              )
            }),
            this
          )
        ...
        (s.prototype.sendChannelAftertouch = function (t, e, n) {
          ...
          ;(n = n || {}),
            (t = parseFloat(t)),
            (isNaN(t) || 0 > t || t > 1) && (t = 0.5)
          var o = Math.round(127 * t)
          return (
            a.toMIDIChannels(e).forEach(function (t) {
              i.send(
                (a.MIDI_CHANNEL_MESSAGES.channelaftertouch << 4) + (t - 1),
                [o],
                i._parseTimeParameter(n.time)
              )
            }),
        ...
        (s.prototype.sendPitchBend = function (t, e, n) {
          ...
          return (
            a.toMIDIChannels(e).forEach(function (t) {
              i.send(
                (a.MIDI_CHANNEL_MESSAGES.pitchbend << 4) + (t - 1),
                [s, r],
                i._parseTimeParameter(n.time)
              )
            }),
        ...
        (s.prototype._parseTimeParameter = function (t) {
          var e, n
          return (
            'string' == typeof t && '+' === t.substring(0, 1)
              ? (e = parseFloat(t)) && e > 0 && (n = a.time + e)
              : (e = parseFloat(t)) > a.time && (n = e),
            n
          )
        }),
    ...
    class o extends i.a {
      ...
      updated() {
        ...
        ;(t.width = n),
          (t.height = i),
          e.clearRect(0, 0, n, i),
          this.drawBackground(e, n, i)
        ;(e.lineWidth = 4),
          e.beginPath(),
          this.buffer.forEach((t, o) => {
    ...
    t.exports = function (t) {
      return function (e, n, s) {
        ...
        if (t && n != n) {
          ...
          for (; c > u; u++) if ((t || u in l) && l[u] === n) return t || u || 0
        return !t && -1
      }
    }
  },
  ...
  function (t, e, n) {
    ...
    t.exports = function (t, e, n, f, v, b, m) {
      ...
      if (
        (T &&
          (x = u(T.call(new t()))) !== Object.prototype &&
          x.next &&
          (c(x, w, !0), i || 'function' == typeof x[h] || s(x, h, p)),
        S &&
          M &&
          'values' !== M.name &&
          ((E = !0),
      ...
      if (
        ...
        A ||
          (((y = e(function (e, n) {
            c(e, y, t)
            var i = f(new g(), e, y)
            return null != n && l(n, b, i[x], i), i
          })).prototype = _),
          (_.constructor = y)),
          (M || I) && (S('delete'), S('has'), b && S('get')),
          (I || k) && S(x),
          m && _.clear && delete _.clear
      } else
        (y = v.getConstructor(e, t, b, x)), s(y.prototype, n), (a.NEED = !0)
      return (
        p(y, t),
        (w[t] = y),
        o(o.G + o.W + o.F * (y != g), w),
  ...
  function (t, e, n) {
    for (
      ...
      (i = o[d[h++]])
        ? (r(i.prototype, a, !0), r(i.prototype, l, !0))
        : (u = !1)
    t.exports = {
      ABV: c,
      CONSTR: u,
  ...
  function (t, e, n) {
    ...
    t.exports =
      ...
      n(5)(function () {
        ...
        ? function (t, e) {
            for (
              var n = s(t), l = arguments.length, c = 1, u = o.f, h = r.f;
              l > c;
              ...
              for (
                var d,
                  p = a(arguments[c++]),
                  f = u ? i(p).concat(u(p)) : i(p),
                  v = f.length,
                  b = 0;
                v > b;

              )
                h.call(p, (d = f[b++])) && (n[d] = p[d])
            return n
          }
        : l
  },
  ...
  function (t, e, n) {
    ...
    function R(t, e, n) {
      ...
      for (
        (t = M(t)) != t || t === E
          ...
          : ((i = I(T(t) / C)),
            t * (r = A(2, -i)) < 1 && (i--, (r *= 2)),
            (t += i + c >= 1 ? u / r : u * A(2, 1 - c)) * r >= 2 &&
              (i++, (r /= 2)),
            i + c >= l
              ? ((o = 0), (i = l))
              : i + c >= 1
              ? ((o = (t * r - 1) * A(2, e)), (i += c))
              : ((o = t * A(2, c - 1) * A(2, e)), (i = 0)));
        e >= 8;
        s[h++] = 255 & o, o /= 256, e -= 8
      );
    ...
    function B(t, e, n, i, o, r) {
      var s = p(+n)
      if (s + e > t[P]) throw S(y)
      for (var a = t[N]._b, l = s + t[O], c = i(+o), u = 0; u < e; u++)
        a[l + u] = c[r ? u : e - u - 1]
    }
    if (s.ABV) {
      if (
      ...
      (x = function (t) {
        ...
        l(_[g], {
          ...
          getFloat32: function (t) {
            return $(V(this, 4, t, arguments[1]), 23, 4)
          },
          getFloat64: function (t) {
            return $(V(this, 8, t, arguments[1]), 52, 8)
          },
          setInt8: function (t, e) {
            B(this, 1, t, z, e)
          },
  ...
  function (t, e, n) {
    ...
    u(function () {
      ...
      (a((i = l.getConstructor(b, 'WeakMap')).prototype, m),
      (s.NEED = !0),
      ...
      for (var f, v, b = u, m = 0, g = !!d && s(d, p, 3); m < c; ) {
        if (m in l) {
          if (
            ((f = g ? g(l[m], m, n) : l[m]),
            (v = !1),
            o(f) && (v = void 0 !== (v = f[a]) ? !!v : i(f)),
            v && h > 0)
          )
            b = t(e, n, f, r(f.length), b, h - 1) - 1
          else {
  ...
  function (t, e, n) {
    ...
    t.exports = function (t) {
      return function (e) {
        for (var n, s = o(e), a = i(s), l = a.length, c = 0, u = []; l > c; )
          r.call(s, (n = a[c++])) && u.push(t ? [n, s[n]] : s[n])
        return u
      }
    }
  },
  ...
  function (t, e, n) {
    var i = n(8),
      ...
      s = n(14)
    t.exports = function (t, e) {
      for (var n, a = r(s(e)), l = a.length, c = 0; l > c; )
        i.f(t, (n = a[c++]), o.f(e, n))
      return t
    }
  },
        ...
        Object.defineProperty(e, '__esModule', {
          ...
          (e.default = function t(e) {
            ...
            if ((0, o.isObject)(e) && (0, o.isObject)(l))
              for (var c in l)
                (0, o.isObject)(l[c])
                  ? (e[c] || Object.assign(e, i({}, c, {})), t(e[c], l[c]))
                  : (0, r.isArray)(l[c])
                  ? (e[c] || Object.assign(e, i({}, c, [])),
                    (e[c] = e[c].concat(l[c])))
                  : Object.assign(e, i({}, c, l[c]))
    ...
    !(function (o) {
      ...
      function p(t, e, n) {
        ...
        if (r == s) i = o = 0
          ...
          var l = r - s
          switch (((o = a > 0.5 ? l / (2 - r - s) : l / (r + s)), r)) {
            case t:
              i = (e - n) / l + (e < n ? 6 : 0)
              break
            case e:
      ...
      function m(t, e) {
        e = 0 === e ? 0 : e || 10
        var n = d(t).toHsl()
        return (n.s -= e / 100), (n.s = R(n.s)), d(n)
      }
      function g(t, e) {
        e = 0 === e ? 0 : e || 10
        var n = d(t).toHsl()
      ...
      function x(t, e) {
        e = 0 === e ? 0 : e || 10
        var n = d(t).toHsl()
        return (n.l += e / 100), (n.l = R(n.l)), d(n)
      }
      function _(t, e) {
        e = 0 === e ? 0 : e || 10
        var n = d(t).toRgb()
        return (
          (n.r = u(0, c(255, n.r - l((-e / 100) * 255)))),
          (n.g = u(0, c(255, n.g - l((-e / 100) * 255)))),
          (n.b = u(0, c(255, n.b - l((-e / 100) * 255)))),
          d(n)
        )
      }
      function w(t, e) {
      ...
      function I(t, e, n) {
        ...
        var i = d(t).toHsl(),
          o = 360 / n,
          r = [d(t)]
        for (i.h = (i.h - ((o * e) >> 1) + 720) % 360; --e; )
          (i.h = (i.h + o) % 360), r.push(d(i))
        return r
      }
      function T(t, e) {
        e = e || 6
        for (
          var n = d(t).toHsv(), i = n.h, o = n.s, r = n.v, s = [], a = 1 / e;
          e--;
      ...
      ;(d.prototype = {
        ...
        setAlpha: function (t) {
          return (this._a = P(t)), (this._roundA = l(100 * this._a) / 100), this
        },
        toHsv: function () {
        ...
        (d.fromRatio = function (t, e) {
          if ('object' == typeof t) {
            var n = {}
            for (var i in t)
              t.hasOwnProperty(i) && (n[i] = 'a' === i ? t[i] : z(t[i]))
            t = n
          }
          return d(t, e)
        }),
        ...
        (d.readability = function (t, e) {
          var n = d(t),
            i = d(e)
          return (
            (o.max(n.getLuminance(), i.getLuminance()) + 0.05) /
            (o.min(n.getLuminance(), i.getLuminance()) + 0.05)
          )
        }),
        ...
        (d.mostReadable = function (t, e, n) {
          ...
          for (var c = 0; c < e.length; c++)
            (i = d.readability(t, e[c])) > l && ((l = i), (a = d(e[c])))
  ...
  function (t, e, n) {
    ...
    ;(c.prototype._setState = i._setState),
      (c.prototype._extendState = i._extendState),
      (c.prototype.set = i.set),
      (c.prototype.get = i.get),
      (c.prototype.down = o.down),
      (c.prototype.up = o.up),
      (c.prototype._trigger = o._trigger),
      (c.prototype._bind = o._bind),
      (c.prototype._map = r._map),
      (c.prototype._offset = r._offset),
      (c.prototype._isNote = r._isNote),
      (c.prototype._toFrequency = r._toFrequency),
      (c.prototype._keyMap = r._keyMap),
      (c.prototype._addKey = s._addKey),
      (c.prototype._removeKey = s._removeKey),
      (c.prototype._isPressed = s._isPressed),
      (c.prototype._makeNote = s._makeNote),
      (c.prototype.clear = s.clear),
      (c.prototype._update = s._update),
      (c.prototype._diff = s._diff),
      (c.prototype._prioritize = a._prioritize),
      (c.prototype._last = a._last),
      (c.prototype._first = a._first),
      (c.prototype._highest = a._highest),
      (c.prototype._lowest = a._lowest),
      (c.prototype._isSpecialKey = l._isSpecialKey),
      (c.prototype._specialKey = l._specialKey),
      (c.prototype._specialKeyMap = l._specialKeyMap),
      (t.exports = c)
  },
  function (t, e, n) {
    var i = n(364),
  ...
  function (t, e, n) {
    ...
    var i = n(3),
      ...
      B =
        ...
        c(function () {
          ...
          : T,
      G = function (t) {
        var e = (D[t] = S(N.prototype))
        return (e._k = t), e
      },
      U =
        j && 'symbol' == typeof N.iterator
          ? function (t) {
              return 'symbol' == typeof t
            }
          : function (t) {
      ...
      Y = function (t, e) {
        g(t)
        for (var n, i = b((e = x(e))), o = 0, r = i.length; r > o; )
          W(t, (n = i[o++]), e[n])
        return t
      },
      K = function (t) {
      ...
      J = function (t, e) {
        if (((t = x(t)), (e = _(e, !0)), t !== q || !o(D, e) || o(L, e))) {
          var n = I(t, e)
          return (
      ...
      X = function (t) {
        for (var e, n = C(x(t)), i = [], r = 0; n.length > r; )
          o(D, (e = n[r++])) || e == R || e == l || i.push(e)
        return i
      },
      Q = function (t) {
        for (
          var e, n = t === q, i = C(n ? L : x(t)), r = [], s = 0;
          i.length > s;

        )
          !o(D, (e = i[s++])) || (n && !o(q, e)) || r.push(D[e])
        return r
      }
    j ||
      (a(
      ...
      (n(52).f = K),
      (n(56).f = Q),
      r && !n(35) && a(q, 'propertyIsEnumerable', K, !0),
      (f.f = function (t) {
        return G(p(t))
      })),
      s(s.G + s.W + s.F * !j, {
    ...
    s(s.S + s.F * !j, 'Symbol', {
      ...
      N.prototype[$] || n(16)(N.prototype, $, N.prototype.valueOf),
      h(N, 'Symbol'),
      h(Math, 'Math', !0),
      h(i.JSON, 'JSON', !0)
  },
      ...
      g = function (t) {
        ...
        if ('string' == typeof e && e.length > 2) {
          var n,
            i,
            o,
            r = (e = m ? e.trim() : d(e, 3)).charCodeAt(0)
          if (43 === r || 45 === r) {
  ...
  function (t, e, n) {
    ...
    i(i.S, 'Math', {
      hypot: function (t, e) {
        for (var n, i, r = 0, s = 0, a = arguments.length, l = 0; s < a; )
          l < (n = o(arguments[s++]))
            ? ((r = r * (i = l / n) * i + 1), (l = n))
            : (r += n > 0 ? (i = n / l) * i : n)
      ...
      'Array',
      {
        from: function (t) {
          var e,
            ...
            g = u(d)
          if (
            (b && (v = i(v, f > 2 ? arguments[2] : void 0, 2)),
            null == g || (p == Array && a(g)))
          )
            for (n = new p((e = l(d.length))); e > m; m++)
              c(n, m, b ? v(d[m], m) : d[m])
          else
            for (h = g.call(d), n = new p(); !(o = h.next()).done; m++)
              c(n, m, b ? s(h, v, [o.value, m], !0) : o.value)
          return (n.length = m), n
        },
      }
    )
  ...
  function (t, e, n) {
    ...
    var i = n(1),
      o = n(14),
      r = [].join
    i(i.P + i.F * (n(51) != Object || !n(23)(r)), 'Array', {
      join: function (t) {
    ...
    i(
      ...
      'Array',
      {
        slice: function (t, e) {
          ...
          for (
            var o = s(t, n), c = s(e, n), u = a(c - o), h = new Array(u), d = 0;
            d < u;
            d++
          )
            h[d] = 'String' == i ? this.charAt(o + d) : this[o + d]
          return h
        },
      }
    )
    ...
    if (
      ...
      c = function (t, e) {
        var n = this instanceof c,
          i = a(t),
          r = void 0 === e
        return !n && i && t.constructor === c && r
          ? t
          : o(
              f
                ? new u(i && !r ? t.source : t, e)
                : u(
    ...
    n(63)('split', 2, function (t, e, i) {
      ...
      if (
        ...
        i = function (t, e) {
          ...
          for (
            a || (i = new RegExp('^' + b.source + '$(?!\\s)', p));
            (l = b.exec(n)) &&
            !(
              (c = l.index + l[0].length) > f &&
              (d.push(n.slice(f, l.index)),
              !a &&
                l.length > 1 &&
                l[0].replace(i, function () {
                  for (h = 1; h < arguments.length - 2; h++)
                    void 0 === arguments[h] && (l[h] = void 0)
                }),
              l.length > 1 && l.index < n.length && s.apply(d, l.slice(1)),
              (u = l[0].length),
              (f = c),
              d.length >= v)
            );
  ...
  function (t, e, n) {
    ...
    N ||
      ((A = function (t) {
        f(this, A, 'Promise', '_h'), p(t), i.call(this)
        try {
  ...
  function (t, e, n) {
    ...
    i(i.S, 'Object', {
      getOwnPropertyDescriptors: function (t) {
        for (
          var e, n, i = r(t), l = s.f, c = o(i), u = {}, h = 0;
          c.length > h;
  ...
  function (t, e, n) {
    ...
    var i = n(21),
      ...
      E = function (t, e) {
        ;(this._t = g(t)), (this._a = c(t)), (this._i = 0), (this._k = e)
      }
    function k(t) {
      var e = a(null)
      return (
    ...
    v(E, 'Dict', function () {
      var t,
        ...
        i = this._k
      do {
        if (this._i >= n.length) return (this._t = void 0), b(1)
      } while (!x(e, (t = n[this._i++])))
      ...
      o(o.S, 'Dict', {
        ...
        set: function (t, e, n) {
          return y && e in Object ? u.f(t, e, r(0, n)) : (t[e] = n), t
        },
        isDict: function (t) {
          return m(t) && l(t) === k.prototype
        },
      })
  },
  function (t, e, n) {
  ...
  function (t, e, n) {
    ...
    r(r.G + r.F, {
      delay: function (t) {
        return new (o.Promise || i.Promise)(function (e) {
    ...
    t.exports = {
      _addKey: function (t) {
        if (this._isNote(t.keyCode) && !this._isPressed(t.keyCode)) {
          ...
          ;(this._state.keys = (this._state.keys || []).concat(e)),
            this._update()
      ...
      _removeKey: function (t) {
        if (this._isPressed(t.keyCode)) {
          ...
          this._state.keys.splice(this._state.keys.indexOf(e), 1),
            this._update()
        }
      },
      ...
      _diff: function (t) {
        var e = this,
          ...
          i = e._state.buffer.map(function (t) {
            return t.keyCode
          }),
          o = []
        n.forEach(function (t) {
          ;-1 === i.indexOf(t) && o.push(t)
        })
        var r = []
        i.forEach(function (t) {
          ...
          o.forEach(function (n) {
            for (var i = 0; i < t.length; i++)
              if (t[i].keyCode === n) {
                ;(t[i].velocity = 0), e._trigger('up', t[i])
                break
              }
          })
      },
  ...
  function (t, e) {
    t.exports = {
      ...
      _first: function () {
        for (var t = 0; t < this._state.polyphony; t++)
          this._state.keys[t].isActive = !0
      },
      _highest: function () {
  ...
  function (t) {
    t.exports = {
      _args: [['nested-object-assign@1.0.3', '/home/travis/build/Tonejs/ui']],
      _development: !0,
      ...
      _requested: {
        type: 'version',
        registry: !0,
        raw: 'nested-object-assign@1.0.3',
      ...
      _requiredBy: ['#DEV:/'],
      _resolved:
        'https://registry.npmjs.org/nested-object-assign/-/nested-object-assign-1.0.3.tgz',
      _spec: '1.0.3',
  ...
  function (t, e, n) {
    var i = {
      './nestedObjectAssign': 136,
      './nestedObjectAssign.js': 136,
    }
    function o(t) {
      var e = r(t)
      return n(e)
    ...
    function u(t, e, n, i, o, u) {
      ...
      if (
        (0 == e &&
          0 == o &&
          (p = (function (t, e, n) {
            for (let i = 0; i < n; i++) if (!h(t[i], e[i])) return i
            return n
          })(t, i, v)),
        n == t.length &&
          u == i.length &&
        ...
        return []
      if (e == n) {
        for (d = r(e, [], 0); o < u; ) d.removed.push(i[o++])
        return [d]
      }
      ...
      let b = (function (t) {
        ...
        for (; e > 0 || n > 0; ) {
          ...
          let r,
            ...
            h = t[e - 1][n],
            d = t[e][n - 1]
          ;(r = h < d ? (h < u ? h : u) : d < u ? d : u) == u
            ? (u == i ? o.push(s) : (o.push(a), (i = u)), e--, n--)
            : r == h
            ? (o.push(c), e--, (i = h))
            : (o.push(l), n--, (i = d))
        }
...
*/
    ...
    class y {
      ...
      _schedule() {
        this._scheduled || ((this._scheduled = !0), m.run(() => this.flush()))
      }
      _processMutations(t) {
      ...
      flush() {
        ...
        let t = {
          ...
          n =
            ((i = e),
            (o = this._effectiveNodes),
            u(i, 0, i.length, o, 0, o.length))
        var i, o
        for (let e, i = 0; i < n.length && (e = n[i]); i++)
          for (let n, i = 0; i < e.removed.length && (n = e.removed[i]); i++)
            t.removedNodes.push(n)
        ...
        return (
          (t.addedNodes.length || t.removedNodes.length) &&
            ((r = !0), this.callback.call(this._target, t)),
          r
        )
      }
      _listenSlots(t) {
    ...
    class _ extends i.a {
      ...
      constructor() {
        super(),
          ...
          (this.options = []),
          (this._observer = new y(this, (t) => {
            ;(this.options = [
              ...this.options,
              ...t.addedNodes.filter(
                (t) => 'option' === t.nodeName.toLowerCase()
              ),
            ]),
              this.options.length &&
      ...
      updated(t) {
        if (t.has('selectedIndex') && -1 !== this.selectedIndex) {
          ...
          this.dispatchEvent(
            ...
            t && (t.selectedIndex = this.selectedIndex),
            this.attribute &&
              this.dispatchEvent(
                new CustomEvent(this.attribute, {
                  detail: this.value,
                  composed: !0,
                  bubbles: !0,
                })
      ...
      set value(t) {
        const e = this.options.findIndex(
          (e) => e.getAttribute('value') === t.toString()
        )
        ;-1 !== e && (this.selectedIndex = e)
      }
      sync(t) {
        this.value = t[this.attribute]
      }
      render() {
        return i.b`
			<style>
    ...
    customElements.define(
      ...
      class extends _ {
        ...
        set(t) {
          t[this.attribute] !== this.value && (t[this.attribute] = this.value)
        }
        render() {
          return i.b`
			<style>
    ...
    customElements.define(
      ...
      class extends i.a {
        ...
        constructor() {
          super(), (this.nocustom = !1), (this.value = 'sine')
        }
        sync(t) {
          ...
          n &&
            n.options.forEach((t) => {
              ...
              e.includes(n) &&
                (this.shadowRoot.querySelector('tone-select-attribute').value =
                  n)
            })
        }
        render() {
    ...
    customElements.define(
      ...
      class extends o.a {
        ...
        constructor() {
          super(), (this.label = 'Oscillator'), (this.sourceType = 'oscillator')
        }
        setAttribute(t, e, n) {
          'type' === t
            ? 'oscillator' === this.sourceType
              ? (n.type = e.value)
              : 'am' === this.sourceType ||
                'fat' === this.sourceType ||
                'fm' === this.sourceType
              ? (n.type = `${this.sourceType}${e.value}`)
              : (n.type = e.value)
            : e.set(n)
        }
        updated(t) {
          t.has('sourceType') &&
            this.dispatchEvent(
              new CustomEvent('sourceType', {
                detail: this.sourceType,
                composed: !0,
                bubbles: !0,
              })
            )
          ...
          : i.b``
			...
			<div id="attributeContainer">
				...
				<tone-oscillator-type 
					...
					label="${
            'fm' === this.sourceType || 'am' === this.sourceType
              ? 'Carrier Type'
              : 'Type'
          }"
					attribute="baseType">
    ...
    const w = i.b`<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M10 17l5-5-5-5v10z"/><path fill="none" d="M0 24V0h24v24H0z"/></svg>`,
      S = i.b`<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M7 10l5 5 5-5z"/><path d="M0 0h24v24H0z" fill="none"/></svg>`
    customElements.define(
      'tone-rack',
      class extends i.a {
        static get properties() {
        ...
        updated(t) {
          ...
          t.has('collapsed') &&
            ...
            Array.from(this.children).forEach((t) => {
              t.assignedNodes
                ? Array.from(t.assignedNodes()).forEach((t) => e(t))
                : e(t),
                t.dispatchEvent(
                  new CustomEvent('collapse', {
                    detail: this.collapsed,
        ...
        _keydown(t) {
          'ArrowRight' === t.key || 'ArrowDown' === t.key
            ? (this.collapsed = !1)
        ...
        render() {
          return i.b`
			...
			<div id="container" class=${this.collapsed ? 'closed' : 'open'} ?square=${
            this.square
          }>
				${
          this.incollapsable
            ...
            : i.b`
					<button 
						...
						role="checkbox" aria-checked="${this.collapsed}">${
                this.collapsed ? w : S
              }</button>`
        }
    ...
    async function k(t) {
      if ('suspended' === Tone.context.state) {
        ...
        try {
          ...
          ;(i = Promise.resolve()), console.log('did not start audio')
        }
        await Promise.all([i, e])
      }
    }
    const M = i.b`<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M8 5v14l11-7z"/><path d="M0 0h24v24H0z" fill="none"/></svg>`,
      A = i.b`<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M0 0h24v24H0z" fill="none"/><path d="M6 6h12v12H6z"/></svg>`
    customElements.define(
      'tone-play-toggle',
      class extends i.a {
        static get properties() {
        ...
        bind(t) {
          this.addEventListener('change', (e) => {
            e.detail ? t.start() : t.stop()
          }),
            setInterval(() => {
              'stopped' === t.state && (this.playing = !1)
            }, 100)
        }
        async _clicked(t) {
          await k(), (this.playing = !this.playing)
        }
        render() {
          return i.b`
			<style>
    ...
    customElements.define(
      ...
      class extends i.a {
        ...
        constructor() {
          super(), (this.color = 'black'), (this.loading = !0)
        }
        _computeRMS(t, e) {
          if (this._waveform && this._waveform.length === e) return
          const n = t.toArray(0),
            i = []
          for (let t = 0; t < e; t++) {
            const o = Math.floor(Math.scale(t, 0, e, 0, n.length - 64)),
              r = o + 64
            let s = 0
            for (let t = o; t < r; t++) s += Math.pow(n[t], 2)
            const a = Math.sqrt(s / 64)
            i[t] = a
          }
          const o = Math.max(...i)
          this._waveform = i.map((t) =>
            Math.scale(Math.pow(t, 0.8), 0, o, 0, 1)
          )
        }
        visualize(t) {
          if (((this.loading = !t.loaded), t.loaded)) {
            const e = t.buffer,
              n = this.shadowRoot.querySelector('canvas')
            ;(n.width = 2 * n.clientWidth), (n.height = 2 * n.clientHeight)
            const { width: i, height: o } = n,
              r = n.getContext('2d')
            r.clearRect(0, 0, i, o), this._computeRMS(e, i)
            const s = Math.scale(t.loopStart, 0, e.duration, 0, i)
            let a = Math.scale(t.loopEnd, 0, e.duration, 0, i)
            0 === t.loopEnd && (a = i), (r.fillStyle = this.color)
            const l = T()(this.color).setAlpha(0.2).toRgbString()
            this._waveform.forEach((e, n) => {
              const c = e * o,
                u = t.reverse ? i - n : n
              t.loop && (r.fillStyle = s > u || u > a ? l : this.color),
                r.fillRect(u, o / 2 - c / 2, 1, c),
                r.fill()
            })
          }
        }
        render() {
          return i.b`
			...
			<div id="loading" ?hidden=${!this.loading} style="color: ${
            this.color
          }">loading</div>
		`
        }
    ...
    customElements.define(
      ...
      class extends o.a {
        ...
        constructor() {
          super(), (this.label = 'Player'), (this.duration = 0)
        }
        bind(t) {
          const e = setInterval(() => {
            t.loaded &&
    ...
    customElements.define(
      ...
      class extends i.a {
        ...
        _logValue(t) {
          const e = Math.pow(t, this.exp),
            n = Math.pow(1, this.exp),
            i = Math.pow(101, this.exp)
          let o = Math.scale(e, n, i, this.min, this.max)
          this.integer && (o = Math.round(o)),
            (this.value = o),
            this.dispatchEvent(
        ...
        _logPosition() {
          const t = Math.scale(
            ...
            this.max,
            Math.pow(1, this.exp),
            Math.pow(101, this.exp)
          )
          return Math.pow(t, 1 / this.exp)
        }
        _beautifyVal() {
          const t = Math.abs(this.min - this.max)
          return t > 10 || this.integer
        ...
        sync(t) {
          const e = this.attribute
          void 0 !== t[e].value
            ? (this.value = Math.clamp(t[e].value, this.min, this.max))
            : (this.value = Math.clamp(t[e], this.min, this.max))
        }
        set(t) {
          const e = this.attribute
          isFinite(this.value) &&
            (void 0 !== t[e].value
              ? t[e].value !== this.value && (t[e].value = this.value)
        ...
        _numberInput(t) {
          const e = Math.clamp(parseFloat(t.target.value), this.min, this.max)
          this.integer ? (this.value = Math.floor(e)) : (this.value = e)
        }
        render() {
          const t = Math.clamp(this._logPosition(), 0, 100)
          let e = t - 1,
            n = 0
          return (
            'center' === this.anchor &&
              ((n = 50 - Math.max(50 - e, 0)), (e = Math.abs(50 - e))),
            i.b`
			<style>
				${N.a}
			</style>
			<div id="container" @keydown=${(t) =>
        'Backspace' === t.key && void 0 !== this.default
              ...
              this.shadowRoot
                ...
                .classList.remove('focus')}
					...
					<div id="line">
						<div id="anchor" class=${
              this.anchor
            } style="width:${e.toString()}%; left:${n.toString()}%"></div>
					</div>
					<div id="circle" style="left: calc(${(t - 1).toString()}% - ${(
              (12 * (t - 1)) /
              100
            ).toString()}px);"></div>
				</div>
    ...
    customElements.define(
      ...
      class extends i.a {
        constructor() {
          super(), (this._waveform = new Tone.Waveform(256))
        }
        bind(t) {
          t.connect(this._waveform),
            (this._canvas = this.shadowRoot.querySelector('canvas')),
            (this._canvas.width = 2 * this._canvas.clientWidth),
            (this._canvas.height = 2 * this._canvas.clientHeight),
        ...
        loop() {
          ...
          const t = this._waveform.getValue(),
          ...
          this._context.clearRect(0, 0, e, n),
            ...
            t.forEach((i, o) => {
              const r = Math.scale(o, 0, t.length, 0, e),
                s = Math.scale(i, -1, 1, 0, n)
              0 === o ? this._context.moveTo(r, s) : this._context.lineTo(r, s)
            }),
    ...
    customElements.define(
      ...
      class extends o.a {
        ...
        async bind(t) {
          ...
          setInterval(() => {
            this.open = 'started' === t.state
          }, 100)
          const e = this.shadowRoot.querySelector('tone-select')
          this.shadowRoot
            .querySelector('#mic')
            .addEventListener('click', (n) => {
              k(), this.open ? t.close() : t.open(e.value)
            }),
            e.addEventListener('change', (n) => {
              this.open && t.open(e.value)
            }),
            this.shadowRoot.querySelector('tone-oscilloscope').bind(t),
    ...
    customElements.define(
      ...
      class extends o.a {
        ...
        constructor() {
          super(), (this.label = 'GrainPlayer'), (this.duration = 0)
        }
        bind(t) {
          const e = setInterval(() => {
            t.loaded &&
    ...
    customElements.define(
      ...
      class extends i.a {
        ...
        _scaleArray(t) {
          ...
          return t
            .slice(0, this.length)
            .map((t) => Math.clamp(Math.abs(t / e), 0, 1))
        }
        sync(t) {
          this._scaleArray(t[this.attribute]).toString() !== this.value &&
            ((this.value = this._scaleArray(t[this.attribute])),
            this.requestUpdate())
        }
        set(t) {
          t[this.attribute] = this.value
        }
        _eventToXY(t) {
          return {
            x: t.offsetX / t.target.offsetWidth,
            y: 1 - t.offsetY / t.target.offsetHeight,
          }
        }
        mousedown(t) {
          if (t.buttons) {
            const { x: e, y: n } = this._eventToXY(t),
              i = this.value.length
            if (
              ((this.value[Math.floor(e * this.length)] = n),
              i !== this.value.length)
            )
              for (let t = 0; t < this.value.length; t++)
                this.value[t] || (this.value[t] = 0)
            this.requestUpdate(),
              this.dispatchEvent(
                new CustomEvent('change', {
                  detail: this.value,
    ...
    customElements.define(
      ...
      class extends i.a {
        ...
        touchstart(t) {
          t.preventDefault(),
            (this.touchid = t.touches[0].identifier),
            (this.active = !0)
        }
        render() {
          const t = 0 !== this.note
      ...
      class extends i.a {
        ...
        constructor() {
          super(),
            ...
            (this.octaves = 4),
            (this.polyphonic = !1),
            (this._computerKeyboard = new $.a({
              polyphony: 1 / 0,
            })),
            this._computerKeyboard.down((t) => {
              k(), this.noteon(t.note)
            }),
        ...
        _touchmove(t) {
          Array.from(t.changedTouches).forEach((t) => {
            ...
            if (n && n.shadowRoot) {
              const i = n.shadowRoot.elementFromPoint(t.clientX, t.clientY)
              i &&
                i.note &&
                e.note !== i.note &&
                ((e.active = !1),
        ...
        render() {
          const t = []
          for (let e = this.rootoctave; e < this.rootoctave + this.octaves; e++)
            t.push(e)
          return i.b`
			<style>
				#container {
      ...
      class extends i.a {
        constructor() {
          super(),
            z.a.enable((t) => {
              t && error(t),
                z.a.addListener('connected', (t) => {
                  'input' === t.port.type && this.requestUpdate()
                }),
                z.a.addListener('disconnected', (t) => {
                  this.requestUpdate()
                })
            })
        }
        _flash() {
          ...
          const t = this.shadowRoot.querySelector('#light')
        ...
        _connectMidi(t) {
          if ('none' === t.target.value)
            return void this.shadowRoot
              .querySelector('#light')
              .classList.remove('connected')
          this.shadowRoot.querySelector('#light').classList.add('connected')
          const e = z.a.getInputById(t.target.value)
          e.addListener('noteon', 'all', (t) => {
            const e = `${t.note.name}${t.note.octave}`,
              n = t.note.number
            this._flash(),
              this.dispatchEvent(
            ...
            e.addListener('controlchange', 'all', (t) => {
              this._flash()
            })
        }
        render() {
      ...
      class extends i.a {
        ...
        bind(t) {
          this.addEventListener('noteon', (e) => {
            t.triggerAttack(e.detail.name)
          }),
            this.addEventListener('noteoff', (e) => {
              this.polyphonic
                ? t.triggerRelease(e.detail.name)
                : t.triggerRelease()
            })
        }
        firstUpdated() {
          super.firstUpdated()
          const t = this.shadowRoot.querySelector('tone-keyboard')
          this.shadowRoot
            .querySelector('tone-midi-in')
            .addEventListener('noteon', (e) => {
              e.stopPropagation(), t.noteon(e.detail.midi)
            }),
            this.shadowRoot
              .querySelector('tone-midi-in')
              .addEventListener('noteoff', (e) => {
                e.stopPropagation(), t.noteoff(e.detail.midi)
              }),
            window.addEventListener('resize', this._resize.bind(this)),
            setTimeout(() => this._resize(), 100)
        }
        _resize() {
          const t = this.shadowRoot.querySelector('#container').clientWidth,
            e = Math.clamp(Math.floor(t / 100) - 1, 1, 8),
            n = Math.ceil(Math.scale(e, 1, 8, 5, 1))
          this.shadowRoot
            .querySelector('tone-keyboard')
            .setAttribute('rootoctave', n),
            this.shadowRoot
              .querySelector('tone-keyboard')
              .setAttribute('octaves', e)
        }
        render() {
          return i.b`
			<style>
    ...
    customElements.define(
      ...
      class extends i.a {
        ...
        _clicked(t) {
          k(), this.disabled && t.stopPropagation()
        }
        render() {
          return i.b`
			<style>
    ...
    customElements.define(
      ...
      class extends i.a {
        ...
        constructor() {
          super(), (this.triggered = !1)
        }
        updated(t) {
          t.has('triggered') &&
            this.dispatchEvent(
              new CustomEvent('change', {
                detail: this.triggered,
                composed: !0,
                bubbles: !0,
              })
            )
        ...
        _keydown(t) {
          k(), (' ' !== t.key && 'Enter' !== t.key) || (this.triggered = !0)
        }
        _keyup(t) {
          ;(' ' !== t.key && 'Enter' !== t.key) || (this.triggered = !1)
        }
        render() {
          return i.b`
			<style>
      ...
      class extends i.a {
        ...
        _mousedown(t, e, n) {
          t.cancelable && t.preventDefault(),
            (this.adding = !this.values[e][n]),
            (this.values[e][n] = this.adding),
            this.requestUpdate()
        }
        _mousemove(t, e, n) {
          if ((t.cancelable && t.preventDefault(), t.buttons))
            (this.values[e][n] = this.adding), this.requestUpdate()
          else if (t.changedTouches) {
            const { clientWidth: i, clientHeight: o } =
                this.shadowRoot.querySelector('#container'),
              { top: r, left: s } = this.getBoundingClientRect()
            Array.from(t.changedTouches).forEach((t) => {
              const a = (t.clientX - s) / i,
                l = (t.clientY - r) / o
              ;(e = Math.floor(a * this.columns)),
                (n = Math.floor(l * this.rows)),
                (this.values[e][n] = this.adding)
            }),
              this.requestUpdate()
          }
        ...
        updated(t) {
          if (t.has('columns') || t.has('rows')) {
            this.values = []
            for (let t = 0; t < this.columns; t++) {
              const t = []
              for (let e = 0; e < this.rows; e++) t[e] = !1
              this.values.push(t)
            }
            this.requestUpdate()
          }
    ...
    customElements.define(
      ...
      class extends i.a {
        ...
        bind(t) {
          ;(this.tone = t), this.loop(t)
        }
        updated(t) {
          if (t.has('position')) {
            const t = Math.scale(this.position, this.min, this.max, 0, 1)
            this.dispatchEvent(
        ...
        loop(t) {
          requestAnimationFrame(this.loop.bind(this, t)),
            this._dragging || (this.position = t.progress)
        }
        _change(t) {
          if (
            ((this._dragging = !0),
            clearTimeout(this._dragTimeout),
            (this._dragTimeout = setTimeout(() => (this._dragging = !1), 200)),
            this.tone)
          ) {
            const e = Math.scale(
              t.detail,
            ...
            ;(this.tone.seconds = e), (this.position = this.tone.progress)
          }
        }
        render() {
          return i.b`
    ...
    customElements.define(
      ...
      class extends i.a {
        ...
        constructor() {
          super(), (this.x = 0.5), (this.y = 0.5)
        }
        _resize() {
          const t = this.shadowRoot.querySelector('#container')
          this._slider.resize(t.clientWidth, t.clientHeight)
        }
        _getXY(t) {
          ...
          let i = t.offsetX,
            o = t.offsetY
          if (t.changedTouches) {
            const { top: e, left: n } = this.getBoundingClientRect()
            ;(i = t.changedTouches[0].clientX - n),
              (o = t.changedTouches[0].clientY - e)
          }
          return {
            x: Math.clamp(i / e, 0, 1),
            y: 1 - Math.clamp(o / n, 0, 1),
          }
        }
        _mousedown(t) {
          const { x: e, y: n } = this._getXY(t)
          ;(this.x = e),
            (this.y = n),
            this.dispatchEvent(
        ...
        render() {
          return i.b`
			...
			<div id="container" 
				...
				<div id="circle" style="left : ${(100 * this.x).toString()}% ; top : ${(
            100 *
            (1 - this.y)
          ).toString()}%">
				</div>
    ...
    customElements.define(
      ...
      class extends D.a {
        ...
        async visualize(t) {
          const e = t.get(),
            n = e.attack + e.decay + e.release,
            i = await Tone.Offline(() => {
              const t = new Tone.Envelope().toMaster()
              t.set(e),
                (t.attack *= 1),
                (t.decay *= 1),
                (t.release *= 1),
                t.toMaster(),
                t.triggerAttack(0.001),
                t.triggerRelease(1 * (e.attack + e.decay + 0.01) + 0.001)
            }, 1 * (n + 0.01) + 0.002)
          ;(this.buffer = i.toArray(0)), this.requestUpdate()
        }
      }
    ...
    customElements.define(
      ...
      class extends i.a {
        ...
        sync(t) {
          const e = t[this.attribute]
          this.shadowRoot.querySelector('tone-select-attribute').value = e
        }
        get value() {
          return this.shadowRoot.querySelector('tone-select-attribute').value
        }
        set value(t) {
          this.shadowRoot.querySelector('tone-select-attribute').value = t
        }
        render() {
          let t = i.b``
          return (
    ...
    class L extends o.a {
      ...
      constructor() {
        super(), (this.label = 'Envelope'), (this.collapsed = !1)
      }
      renderAttributes() {
        return i.b``
      }
    ...
    customElements.define('tone-envelope', L)
    customElements.define(
    ...
    customElements.define(
      ...
      class extends i.a {
        ...
        constructor() {
          super(), (this.color = '#777')
        }
        bind(t) {
          if ((this.stereo, this.stereo)) {
            const e = new Tone.Split()
            t.connect(e),
              (this._meters = [new Tone.Meter(0.9), new Tone.Meter(0.9)]),
              e.left.connect(this._meters[0]),
              e.right.connect(this._meters[1])
          } else
            (this._meters = [new Tone.Meter(0.9)]), t.connect(this._meters[0])
          ;(this._canvas = this.shadowRoot.querySelector('canvas')),
            (this._canvas.width = 2 * this._canvas.clientWidth),
            (this._canvas.height = 2 * this._canvas.clientHeight),
            (this._context = this._canvas.getContext('2d')),
        ...
        loop() {
          requestAnimationFrame(this.loop.bind(this))
          const { width: t, height: e } = this._canvas,
            n = this._meters.map((t) => t.getLevel()),
            i = n.map((t) => Math.clamp(Math.scale(t, -100, 6, 0, e), 4, e))
          this._context.clearRect(0, 0, t, e)
          const o = t / this._meters.length
          this._context.fillStyle = this.color
          const r = this._meters.length > 1 ? 5 : 0
          i.forEach((t, n) => {
            this._context.fillRect(n * o + r * n, e - t, o - r, t)
          }),
            this.level &&
              Array.from(this.shadowRoot.querySelectorAll('.level')).forEach(
                (t, e) => {
                  let i = n[e]
                  i < -100 && (i = -1 / 0), (t.textContent = i.toFixed(2))
                }
              )
        }
        render() {
          ...
          this.level
            ? i.b`
					<div id="level" style="color:${this.color}">${t}</div>`
            : i.b``
        }
			</div>
		`
    ...
    customElements.define(
      ...
      class extends i.a {
        ...
        render() {
          if ('undefined' !== this.presets) {
            const t = JSON.parse(this.presets)
            return i.b`
				<style>
					:host {
						display: block;
    ...
    class H extends o.a {
      ...
      constructor() {
        super(), (this.label = ''), (this.effect = !1), (this.polyphonic = !1)
      }
      bind(t) {
        this.shadowRoot.querySelector('tone-meter').bind(t)
        const e = this.shadowRoot.querySelector('tone-presets')
        e && e.bind(t),
          this.polyphonic
            ? t.voices.forEach((t) => super.bind(t))
            : super.bind(t)
      }
      renderAttributes() {
        return i.b``
      ...
      render() {
        ...
        return i.b`
          ...
          this.nopresets
            ? i.b``
            : i.b`<tone-presets presets=${this.presets}></tone-presets>`
        }
			</tone-rack square>
		`
      }
    }
    customElements.define('tone-instrument', H)
    const V = [
      {
        portamento: 0,
        oscillator: {
    ...
    customElements.define(
      ...
      class extends H {
        constructor() {
          super(), (this.label = 'Synth'), (this.presets = JSON.stringify(V))
        }
        renderAttributes() {
          return i.b`
			<tone-slider 
    ...
    const W = [
      {
        ...
        modulation: {
          ...
          phase: 0,
          partials: [
            0.8105694691387023, 0, 0.0900632743487447, 0, 0.03242277876554809,
            0, 0.016542234064055146, 0, 0.010007030483193857, 0,
            0.00669892123255126, 0, 0.004796269048158, 0, 0.6, 0,
            0.0028047386475387615, 0.4727272727272728, 0.002245344789857901, 0,
            0.0018380260071172384, 0, 0.0015322674274833694, 0,
            0.0012969111506219236, 0.8727272727272728, 0.0011118922759104286, 0,
            0.0009638162534348421, 0, 0.0008434645880735718, 0,
          ],
          partialCount: 32,
        },
        modulationEnvelope: {
    ...
    customElements.define(
      ...
      class extends H {
        constructor() {
          super(), (this.label = 'FMSynth'), (this.presets = JSON.stringify(W))
        }
        renderAttributes() {
          return i.b`
			<tone-slider 
    ...
    customElements.define(
      ...
      class extends H {
        constructor() {
          super(), (this.label = 'AMSynth'), (this.presets = JSON.stringify(Y))
        }
        renderAttributes() {
          return i.b`
			<tone-slider 
    ...
    customElements.define(
      ...
      class extends H {
        constructor() {
          super(), (this.label = 'MembraneSynth')
        }
        renderAttributes() {
          return i.b`
			<tone-slider 
      ...
      class extends D.a {
        ...
        drawBackground(t, e, n) {
          ;(t.fillStyle = 'rgba(255, 255, 255, 0.3)'),
            t.fillRect(0, 0.6 * n, e, 3),
            t.fill()
        }
        async visualize(t) {
          ;(this.buffer = t
            .getFrequencyResponse()
            .map((t) => Math.pow(t, 0.5))),
            this.requestUpdate()
        }
      }
    )
    ...
    customElements.define(
      ...
      class extends i.a {
        ...
        sync(t) {
          this.shadowRoot.querySelector('tone-slider').sync(t)
        }
        render() {
          return i.b`
			<style>
    ...
    customElements.define(
      ...
      class extends o.a {
        ...
        constructor() {
          super(), (this.collapsed = !0)
        }
        bind(t) {
          super.bind(t),
            this.shadowRoot.querySelector('tone-play-toggle').bind(t),
            setInterval(() => {
              this.shadowRoot.querySelector('#position').textContent =
                t.position
            }, 100)
        }
        render() {
    ...
    customElements.define(
      ...
      class extends o.a {
        ...
        constructor() {
          super(), (this.label = 'Compressor'), (this.collapsed = !1)
        }
        renderAttributes() {
          return i.b``
        }
    ...
    const K = i.b`<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M16.5 12c0-1.77-1.02-3.29-2.5-4.03v2.21l2.45 2.45c.03-.2.05-.41.05-.63zm2.5 0c0 .94-.2 1.82-.54 2.64l1.51 1.51C20.63 14.91 21 13.5 21 12c0-4.28-2.99-7.86-7-8.77v2.06c2.89.86 5 3.54 5 6.71zM4.27 3L3 4.27 7.73 9H3v6h4l5 5v-6.73l4.25 4.25c-.67.52-1.42.93-2.25 1.18v2.06c1.38-.31 2.63-.95 3.69-1.81L19.73 21 21 19.73l-9-9L4.27 3zM12 4L9.91 6.09 12 8.18V4z"/><path d="M0 0h24v24H0z" fill="none"/></svg>`,
      J =
        (i.b`<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M18.5 12c0-1.77-1.02-3.29-2.5-4.03v8.05c1.48-.73 2.5-2.25 2.5-4.02zM5 9v6h4l5 5V4L9 9H5z"/><path d="M0 0h24v24H0z" fill="none"/></svg>`,
        i.b`<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M3 9v6h4l5 5V4L7 9H3zm13.5 3c0-1.77-1.02-3.29-2.5-4.03v8.05c1.48-.73 2.5-2.25 2.5-4.02zM14 3.23v2.06c2.89.86 5 3.54 5 6.71s-2.11 5.85-5 6.71v2.06c4.01-.91 7-4.49 7-8.77s-2.99-7.86-7-8.77z"/><path d="M0 0h24v24H0z" fill="none"/></svg>`)
    customElements.define(
      'tone-unmute',
      class extends o.a {
        static get properties() {
        ...
        constructor() {
          super(),
            ...
            (this.focused = !1),
            setInterval(() => {
              this.suspended = 'suspended' === Tone.context.state
            }, 100)
        }
        updated(t) {
          if (t.has('muted')) {
            Tone.Master.mute = this.muted
            const t = this.shadowRoot.querySelector('#volume')
            this.novolume || this.muted || t.min != t.value || (t.value = 0)
          }
        }
        _clicked(t) {
          k(), 'suspended' !== Tone.context.state && (this.muted = !this.muted)
        }
        _adjustVolume(t) {
          t.detail === t.target.min ? (this.muted = !0) : (this.muted = !1),
            (Tone.Master.volume.value = t.detail)
        }
        render() {
          return i.b`
			<style>
    ...
    customElements.define(
      ...
      class extends i.a {
        ...
        updated() {
          const t = this.shadowRoot.querySelector('canvas')
          ;(t.width = 2 * t.clientWidth), (t.width = 2 * t.clientHeight)
          const { width: e, height: n } = t,
            ...
            o = (function (t) {
              const e = new Array(t),
                ...
                o = new Array(t),
                r = [e, i, o, n]
              for (let n = 0; n < t; n++) e[n] = Math.sin((2 * Math.PI * n) / t)
              for (let e = 0; e < t; e++) i[e] = (((e + t / 2) % t) / t) * 2 - 1
              for (let e = 0; e < t; e++)
                o[e] =
                  e < t / 3
                    ? (e / (t / 3)) * 2 - 1
              ...
              for (let e = 0; e < t; e++) {
                const i = t / 16
                n[e] = e < i ? -1 : e < t / 2 ? 1 : e < t - i ? -1 : 1
              }
              return r[Math.floor(Math.random() * r.length)]
            })(e + 1)
          i.beginPath(),
            o.forEach((t, e) => {
              const o = Math.scale(t, -1, 1, 0.25 * n, 0.75 * n)
              0 === e ? i.moveTo(e, o) : i.lineTo(e, o)
            }),
            i.lineTo(e, n),
            i.lineTo(0, n),
            (i.fillStyle = '#22DBC0'),
    ...
    const X = i.b`<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M16.59 8.59L12 13.17 7.41 8.59 6 10l6 6 6-6z"/><path d="M0 0h24v24H0z" fill="none"/></svg>`,
      Q = i.b`<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M12 8l-6 6 1.41 1.41L12 10.83l4.59 4.58L18 14z"/><path d="M0 0h24v24H0z" fill="none"/></svg>`
    customElements.define(
      'tone-drawer',
      class extends i.a {
        static get properties() {
        ...
        updated(t) {
          if (t.has('collapsed') && !this.collapsed) {
            const t = (t) => {
              t.dispatchEvent(
                new CustomEvent('collapse', {
                  detail: this.collapsed,
            ...
            Array.from(this.children).forEach((e) => {
              e.assignedNodes
                ? Array.from(e.assignedNodes()).forEach((e) => t(e))
                : t(e),
                e.dispatchEvent(
                  new CustomEvent('collapse', {
                    detail: this.collapsed,
    ...
    const Z = i.b`<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M19 6.41L17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12z"/><path d="M0 0h24v24H0z" fill="none"/></svg>`,
      tt = i.b`<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M0 0h24v24H0z" fill="none"/><path d="M3 18h18v-2H3v2zm0-5h18v-2H3v2zm0-7v2h18V6H3z"/></svg>`
    customElements.define(
      'tone-side-panel',
      class extends i.a {
        static get properties() {
        ...
        async fetchExamples() {
          try {
            const t = await fetch('./js/ExampleList.json')
            ;(this.examples = await t.json()), this.requestUpdate()
          } catch (t) {
        ...
        render() {
          const t = 0 === Object.keys(this.examples).length
          return i.b`
			<style>
				:host {
					display: inline-block;
          ...
          this.collapsed
            ...
            : i.b`
					...
					${Object.entries(this.examples).map(
            ([t, e]) => i.b`
						<h3>${t}</h3>
						<ul>
    ...
    customElements.define(
      ...
      class extends i.a {
        ...
        updated(t) {
          t.has('open') && (this.collapsed = !this.open)
        }
        render() {
          return i.b`
			<style>
    ...
    customElements.define(
      ...
      class extends i.a {
        ...
        firstUpdated() {
          super.firstUpdated(), this._loop()
        }
        bind(t) {
          t.connect(this._analyser)
        }
        _loop() {
          requestAnimationFrame(this._loop.bind(this))
          const t = this.shadowRoot.querySelector('canvas'),
            e = this.shadowRoot.querySelector('#container'),
            n = t.getContext('2d')
          ;(t.width = 2 * e.clientWidth), (t.height = 2 * e.clientHeight)
          const i = this._analyser.getValue()
          this._isSilent(i)
            ? this._drawAnalysis(this._waveform, !0, n)
            : this._drawAnalysis(i, !1, n)
        }
        _isSilent(t) {
          let e = 0
          for (let n = 0; n < t.length; n++) e += Math.pow(t[n], 2)
          const n = Math.sqrt(e / t.length)
          return (
            (this._rms = Math.max(n, 0.9 * this._rms)),
            this._rms < this._silentThresh
          )
        }
        _drawAnalysis(t, e, n) {
          const { width: i, height: o } = n.canvas
          let r,
            s = 0.2 * o
          e &&
            (s = Math.scale(
          ...
          for (let e = 0, a = t.length; e < a; e++) {
            const l = Math.scale(e, 0, a - 1, 0, i),
              c = Math.scale(t[e], -1, 1, o - s, s)
            0 === e ? ((r = c), n.moveTo(l, c)) : n.lineTo(l, c)
          }
          n.lineTo(i, o),
            n.lineTo(0, o),
            n.lineTo(0, r),
    ...
    const et = i.b`<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M8 5v14l11-7z"/><path d="M0 0h24v24H0z" fill="none"/></svg>`
    customElements.define(
      'tone-start-context',
      class extends i.a {
        static get properties() {
        ...
        constructor() {
          super(), (this.running = !1)
        }
        firstUpdated() {
          const t = setInterval(() => {
            ;(this.running = 'running' === Tone.context.state),
              this.running && clearInterval(t)
          }, 100)
        }
        async _clicked(t) {
          await k(), (this.running = 'running' === Tone.context.state)
        }
        render() {
          return i.b`
			<style>
    ...
    customElements.define(
      ...
      class extends i.a {
        constructor() {
          super(), (this._fft = new Tone.FFT(256))
        }
        bind(t) {
          t.connect(this._fft),
            (this._canvas = this.shadowRoot.querySelector('canvas')),
    ...
    customElements.define(
      ...
      class extends i.a {
        ...
        loop(t) {
          requestAnimationFrame(this.loop.bind(this, t))
          const { width: e, height: n } = this._canvas,
            i = this._context
          i.clearRect(0, 0, e, n), (i.fillStyle = '#eee')
          const o = Math.min(e, n)
          i.arc(e / 2, n / 2, o / 2, 0, 2 * Math.PI, !1), i.fill()
          const r = t.progress
          i.beginPath(), (i.fillStyle = this.color), i.moveTo(e / 2, n / 2)
          const s = Math.PI / 2
          i.arc(e / 2, n / 2, o / 2, -s, r * Math.PI * 2 - s, !1), i.fill()
        }
        render() {
          return i.b`
			<style>
    ...
    customElements.define('tone-effect', nt)
    customElements.define(
      'tone-chorus',
      class extends nt {
        constructor() {
          super(), (this.label = 'Chorus')
        }
        renderAttributes() {
          return i.b`
			<tone-slider 
    ...
    customElements.define(
      ...
      class extends nt {
        constructor() {
          super(), (this.label = 'PingPongDelay')
        }
        renderAttributes() {
          return i.b`
			<tone-slider 
    ...
    customElements.define(
      ...
      class extends nt {
        ...
        constructor() {
          super(), (this.label = 'Reverb'), (this.generating = !1)
        }
        bind(t) {
          super.bind(t), this.generate(t)
          let e = -1
        ...
        async generate(t) {
          ;(this.generating = !0), await t.generate(), (this.generating = !1)
        }
        renderAttributes() {
          return i.b`
			${
